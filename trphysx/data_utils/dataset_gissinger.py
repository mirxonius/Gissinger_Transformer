...
class GissingerDataset(PhysicalDataset):
    """Dataset for the Gissinger numerical example
    """
    def embed_data(self, h5_file: h5py.File, embedder: EmbeddingModel) -> None:
        """Embeds gissinger data into a 1D vector representation for the transformer.
