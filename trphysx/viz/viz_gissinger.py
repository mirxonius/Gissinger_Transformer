...
class GissingerViz(Viz):
    """Visualization class for Gissinger ODE
    ...
    def plotPrediction(self,
        ...
        """Plots a 3D line of a single Gissinger prediction
        ...
        if(not epoch is None):
            file_name = 'gissingerPred{:d}_{:d}'.format(pid, epoch)
        else:
            file_name = 'gissingerPred{:d}'.format(pid)
    ...
    def plotMultiPrediction(self,
        ...
        """Plots the 3D lines of multiple Gissinger predictions
        ...
        if epoch is not None:
            file_name = 'gissingerMultiPred{:d}_{:d}'.format(pid, epoch)
        else:
            file_name = 'gissingerMultiPred{:d}'.format(pid)
    ...
    def plotPredictionScatter(self,
        ...
        """Plots scatter plots of a Gissinger prediction contoured based on distance from the basins.
        ...
        if(not epoch is None):
            file_name = 'gissingerScatter{:d}_{:d}'.format(pid, epoch)
        else:
            file_name = 'gissingerScatter{:d}'.format(pid)
