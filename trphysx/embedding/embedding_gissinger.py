...
class GissingerEmbedding(EmbeddingModel):
    """Embedding Koopman model for the Gissinger ODE system

    Args:
        config (PhysConfig): Configuration class with transformer/embedding parameters
    """
    model_name = "embedding_gissinger"
...
class GissingerEmbeddingTrainer(EmbeddingTrainingHead):
    ...
    def __init__(self, config: PhysConfig):
        ...
        """
        super().__init__()
        self.embedding_model = GissingerEmbedding(config)
